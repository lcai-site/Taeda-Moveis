...
const DashboardGrid: React.FC<DashboardGridProps> = ({ data, isLoading, error, aggregation, activeTab, theme }) => {
  ...
  const ICONS = {
    ...
    qualified: <svg xmlns="http://www.w.org/2000/svg" className="h-6 w-6 sm:h-8 sm:w-8 text-brand-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
        ...
        <MetricCard title="Total Investido" value={`R$ ${totalCost.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`} icon={ICONS.cost} description="No período" />
